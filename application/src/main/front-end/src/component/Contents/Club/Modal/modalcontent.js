...
const ModalContents = ({ clubName, imageUrl, tags }) => {
  ...
  return (
    <div className="overflow-auto max-h-[400px] sm:max-h-[500px] md:max-h-[600px] lg:max-h-[700px]">
      ...
      {/* 부스 (제목) */}
      <p className="text-lg text-center font-bold mt-3">🌟 대학교 동아리 연합회 🌟</p>

      {/* 부스 (내용) */}
      <p className="text-sm text-left mt-2 p-3" dangerouslySetInnerHTML={{ __html: formattedDescription }} />
