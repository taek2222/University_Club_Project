...
function HeaderRecycle({ onClick, imageSrc, altText, label }) {
    return(
        ...
        <div className="rounded-full p-[2px] mb-1 bg-gradient-to-r from-story-start via-story-middle to-story-end transform transition-transform hover:scale-110 hover:cursor-pointer">
